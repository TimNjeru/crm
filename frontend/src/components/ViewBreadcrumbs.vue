<template>
  <div class="flex items-center">
    <router-link
      :to="{ name: routeName }"
      class="px-0.5 py-1 text-lg font-outfit font-medium tracking-tight focus:outline-none focus-visible:ring-2 focus-visible:ring-outline-gray-3"
      :class="[
    ...
    >
      <template #default="{ open }">
        <Button
          variant="ghost"
          class="text-lg font-outfit font-medium tracking-tight text-nowrap"
